"""
Item and equipment related commands. This file is mostly copied directly
from the file found at:
https://github.com/evennia/ainneve/blob/master/commands/equip.py
and modified as needed for DOG.
"""
